    ...
    public LinearTimerView(Context context,
        ...
        try {
            this.circleRadiusInDp =
                    (int) typedArray.getDimension(R.styleable.LinearTimerView_lineartimer_radius, 5);
            this.strokeWidthInDp =
                    (int) typedArray.getDimension(R.styleable.LinearTimerView_lineartimer_strokeWidth, 2);
            this.initialColor =
                    typedArray.getColor(R.styleable.LinearTimerView_lineartimer_initialColor,
                            ContextCompat.getColor(getContext(), R.color.lineartimer_colorInitial));
            this.progressColor =
                    typedArray.getColor(R.styleable.LinearTimerView_lineartimer_progressColor,
                            ContextCompat.getColor(getContext(), R.color.lineartimer_colorProgress));
            this.startingPoint =
                    typedArray.getInt(R.styleable.LinearTimerView_lineartimer_startingPoint, 270);
        } catch (Exception ex) {
            ex.printStackTrace();
        } finally {
            typedArray.recycle();
